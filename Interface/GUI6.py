...
delay = Radiobutton(effectsFrame, text="Delay", variable=v, value=1).grid(row=0,column=0,sticky = W)
eq = Radiobutton(effectsFrame, text="EQ", variable=v, value=2,anchor=W).grid(row=0,column=1,sticky = W)

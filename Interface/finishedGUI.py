...
show_eqbq = Label(eqFrame, text="0.0")

entry_eqtq = Entry(eqFrame, width=6)
show_eqtq = Label(eqFrame, text="0.0")

entry_eqpq = Entry(eqFrame, width=6)
show_eqpq = Label(eqFrame, text="0.0")
...
show_delayt = Label(delayFrame, text="0.0")
...
def eqvalsetb1(event):
	"""This function is called when a value is entered in the Bass Q entry slot and the Enter key on the keyboard is pressed.
	If the value entered is outside the interval of 0.1 - 6 an error message is displayed.The outp function is then called and the
	entered value is stored in the string.
	"""
...
def eqvalsetp1(event):
	"""This function is called when a value is entered in the Peak Q entry slot and the Enter key on the keyboard is pressed.
	If the value entered is outside the interval of 0.1 - 6 an error message is displayed. The outp function is then called and the
	entered value is stored in the string.
	"""
...
def eqvalsett1(event):
	"""This function is called when a value is entered in the Trebble Q entry slot and the Enter key on the keyboard is pressed.
	If the value entered is outside the interval of 0.1 - 6 an error message is displayed. The outp function is then called and the
	entered value is stored in the string.
	"""
...
def delayvalset(event):
	"""This function is called when a value is entered in the Delay time entry slot and the Enter key on the keyboard is pressed.
	If the value entered is outside the interval of 0 - 1 an error message is displayed. The outp function is then called and the
	entered value is stored in the string.
	"""

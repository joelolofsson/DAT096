...
## Clock signal
#Bank = 35, Pin clk = IO_L12P_T1_MRCC_35,					Sch name = CLK100MHZ
...
set_property IOSTANDARD LVTTL [get_ports {valueout[10]}]
set_property IOSTANDARD LVTTL [get_ports {valueout[9]}]
set_property IOSTANDARD LVTTL [get_ports {valueout[8]}]
set_property IOSTANDARD LVTTL [get_ports {valueout[7]}]
set_property IOSTANDARD LVTTL [get_ports {valueout[6]}]
set_property IOSTANDARD LVTTL [get_ports {valueout[5]}]
set_property IOSTANDARD LVTTL [get_ports {valueout[4]}]
set_property IOSTANDARD LVTTL [get_ports {valueout[3]}]
set_property IOSTANDARD LVTTL [get_ports {valueout[2]}]
set_property IOSTANDARD LVTTL [get_ports {valueout[1]}]
set_property IOSTANDARD LVTTL [get_ports {valueout[0]}]
set_property IOSTANDARD LVTTL [get_ports clk]
set_property IOSTANDARD LVTTL [get_ports PWMCLKout]
set_property IOSTANDARD LVTTL [get_ports pwmout]
set_property IOSTANDARD LVTTL [get_ports reset]
set_property IOSTANDARD LVTTL [get_ports {Value[10]}]
set_property IOSTANDARD LVTTL [get_ports {Value[9]}]
set_property IOSTANDARD LVTTL [get_ports {Value[8]}]
set_property IOSTANDARD LVTTL [get_ports {Value[7]}]
set_property IOSTANDARD LVTTL [get_ports {Value[6]}]
set_property IOSTANDARD LVTTL [get_ports {Value[5]}]
set_property IOSTANDARD LVTTL [get_ports {Value[4]}]
set_property IOSTANDARD LVTTL [get_ports {Value[3]}]
set_property IOSTANDARD LVTTL [get_ports {Value[2]}]
set_property IOSTANDARD LVTTL [get_ports {Value[1]}]
set_property IOSTANDARD LVTTL [get_ports {Value[0]}]
set_property DRIVE 12 [get_ports {valueout[10]}]
set_property DRIVE 12 [get_ports {valueout[9]}]
set_property DRIVE 12 [get_ports {valueout[8]}]
set_property DRIVE 12 [get_ports {valueout[7]}]
set_property DRIVE 12 [get_ports {valueout[6]}]
set_property DRIVE 12 [get_ports {valueout[5]}]
set_property DRIVE 12 [get_ports {valueout[4]}]
set_property DRIVE 12 [get_ports {valueout[3]}]
set_property DRIVE 12 [get_ports {valueout[2]}]
set_property DRIVE 12 [get_ports {valueout[1]}]
set_property DRIVE 12 [get_ports {valueout[0]}]
set_property DRIVE 12 [get_ports clk]
set_property DRIVE 12 [get_ports PWMCLKout]
set_property DRIVE 12 [get_ports pwmout]
set_property DRIVE 12 [get_ports reset]
set_property DRIVE 12 [get_ports {Value[10]}]
set_property DRIVE 12 [get_ports {Value[9]}]
set_property DRIVE 12 [get_ports {Value[8]}]
set_property DRIVE 12 [get_ports {Value[7]}]
set_property DRIVE 12 [get_ports {Value[6]}]
set_property DRIVE 12 [get_ports {Value[5]}]
set_property DRIVE 12 [get_ports {Value[4]}]
set_property DRIVE 12 [get_ports {Value[3]}]
set_property DRIVE 12 [get_ports {Value[2]}]
set_property DRIVE 12 [get_ports {Value[1]}]
set_property DRIVE 12 [get_ports {Value[0]}]
set_property SLEW SLOW [get_ports {valueout[10]}]
set_property SLEW SLOW [get_ports {valueout[9]}]
set_property SLEW SLOW [get_ports {valueout[8]}]
set_property SLEW SLOW [get_ports {valueout[7]}]
set_property SLEW SLOW [get_ports {valueout[6]}]
set_property SLEW SLOW [get_ports {valueout[5]}]
set_property SLEW SLOW [get_ports {valueout[4]}]
set_property SLEW SLOW [get_ports {valueout[3]}]
set_property SLEW SLOW [get_ports {valueout[2]}]
set_property SLEW SLOW [get_ports {valueout[1]}]
set_property SLEW SLOW [get_ports {valueout[0]}]
set_property SLEW SLOW [get_ports clk]
set_property SLEW SLOW [get_ports PWMCLKout]
set_property SLEW SLOW [get_ports pwmout]
set_property SLEW SLOW [get_ports reset]
set_property SLEW SLOW [get_ports {Value[10]}]
set_property SLEW SLOW [get_ports {Value[9]}]
set_property SLEW SLOW [get_ports {Value[8]}]
set_property SLEW SLOW [get_ports {Value[7]}]
set_property SLEW SLOW [get_ports {Value[6]}]
set_property SLEW SLOW [get_ports {Value[5]}]
set_property SLEW SLOW [get_ports {Value[4]}]
set_property SLEW SLOW [get_ports {Value[3]}]
set_property SLEW SLOW [get_ports {Value[2]}]
set_property SLEW SLOW [get_ports {Value[1]}]
set_property SLEW SLOW [get_ports {Value[0]}]

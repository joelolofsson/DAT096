...
-- Date        : Thu Feb 20 12:43:05 2014
-- Host        : running 32-bit Service Pack 1  (build 7601)
-- Command     : write_vhdl -force -mode funcsim
--               c:/CHALMERS/DAT096/DAT096/ADCDAC/DAC_Vivado/DAC_Vivado.srcs/sources_1/ip/ADC/ADC_funcsim.vhdl
-- Design      : ADC
...
U0: unisim.vcomponents.XADC
    generic map(
      ...
      IS_DCLK_INVERTED => '0',
      SIM_DEVICE => "7SERIES",
      SIM_MONITOR_FILE => "c:/CHALMERS/DAT096/DAT096/ADCDAC/DAC_Vivado/DAC_Vivado.srcs/sources_1/ip/ADC/ADC/simulation/functional/design.txt"
    )
    port map (
      ALM(7) => alarm_out,
